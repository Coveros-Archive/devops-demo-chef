...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "ggotimer-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/coveros"
  #   chef.validation_client_name = "coveros-validator"
  #   chef.validation_key_path = ".chef/coveros-validator.pem"
  # end
end
